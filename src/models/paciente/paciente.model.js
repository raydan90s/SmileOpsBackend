...
const createPaciente = async (pacienteData, req) => {
...
const updatePaciente = async (id, pacienteData, req) => {
  return executeWithAudit(pool, req, async (client) => {
    const query = `
...
const deactivatePaciente = async (id, req) => {
  return executeWithAudit(pool, req, async (client) => {
    const query = `
      UPDATE public."odontblpacientes"
      SET "cestado" = false
...
const activatePaciente = async (id, req) => {
  return executeWithAudit(pool, req, async (client) => {
    const query = `
      UPDATE public."odontblpacientes"
      SET "cestado" = true
