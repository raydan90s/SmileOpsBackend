...
const createTipoProveedor = async (tipoProveedorData) => {
    const query = `
...
const updateTipoProveedor = async (iid_tipo_proveedor, tipoProveedorData) => {
    const query = `
...
const deleteTipoProveedor = async (iid_tipo_proveedor) => {
    const query = `
        UPDATE public.tbl_tipos_proveedor
        SET bactivo = false
        WHERE iid_tipo_proveedor = $1
